...
# Script to build Flutter app with environment variables from .env file
...
echo "Building Flutter app with Supabase configuration..."
echo "SUPABASE_URL: $SUPABASE_URL"
echo ""

# Build flutter with the dart-define arguments
# Pass any additional arguments to flutter build (e.g., apk, ios, etc.)
flutter build $DART_DEFINES "$@"
