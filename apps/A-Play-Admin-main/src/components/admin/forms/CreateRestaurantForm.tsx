  ...
  const createRestaurantMutation = useMutation({
    mutationFn: async (restaurantData: typeof formData) => {
      ...
      const { data, error } = await supabase
        .from("restaurants")
        .insert([{ ...restaurantData, address: restaurantData.location, price_range: restaurantData.price_range ? Number(restaurantData.price_range) : null, created_by: user.id }])
        .select()
        .single();
